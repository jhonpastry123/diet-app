...
public class MyFoodItemDataSource extends PageKeyedDataSource<Integer, FoodItem> {
    ...
    public MyFoodItemDataSource(@NonNull Bundle params) {
        mParams = params;
    ...
    public void loadInitial(@NonNull LoadInitialParams<Integer> params, @NonNull final LoadInitialCallback<Integer, FoodItem> callback) {
        ...
        rest.FoodItemsIndex(1, mParams.getInt("user_id"), mParams.getString("q"))
    ...
    public void loadAfter(@NonNull final LoadParams<Integer> params, @NonNull final LoadCallback<Integer, FoodItem> callback) {
        ...
        rest.FoodItemsIndex(params.key, mParams.getInt("user_id"), mParams.getString("q"))
                .enqueue(new Callback<Wrappers.Paginated<FoodItem>>() {
    ...
    public static class Factory extends DataSource.Factory<Integer, FoodItem> {
        ...
        public MutableLiveData<MyFoodItemDataSource> source = new MutableLiveData<>();
        ...
        public DataSource<Integer, FoodItem> create() {
            MyFoodItemDataSource source = new MyFoodItemDataSource(params);
