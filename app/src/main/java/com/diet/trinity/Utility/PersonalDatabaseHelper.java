...
public class PersonalDatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String COL_13 = "weekly_points";
    public static final String COL_14 = "daily_points";
    public static final String COL_15 = "next_points";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " + TABLE_NAME + " (ID INTEGER PRIMARY KEY AUTOINCREMENT, weight TEXT, height TEXT, waist TEXT, neck TEXT, thigh TEXT, weekly_units TEXT, daily_units TEXT, date TEXT, days TEXT, next_units TEXT, user_id TEXT, weekly_points TEXT, daily_points TEXT, next_points TEXT)");
    }
    @Override
