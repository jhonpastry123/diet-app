...
public class MealDatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String COL_11 = "units";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " + TABLE_NAME + " (ID INTEGER PRIMARY KEY AUTOINCREMENT,foodname TEXT,carbon TEXT, protein TEXT, fat TEXT, gram TEXT, points TEXT, categoryid TEXT, timing TEXT, date TEXT, units TEXT)");
    }
    @Override
