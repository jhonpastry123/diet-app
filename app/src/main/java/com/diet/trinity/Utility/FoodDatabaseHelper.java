...
public class FoodDatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String COL_8="kcal";
    public static final String COL_9="serving_size";
    public static final String COL_10="serving_prefix";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " + TABLE_NAME + " (ID INTEGER ,foodname TEXT,carbon TEXT, protein TEXT, fat TEXT, gram TEXT, categoryid TEXT, kcal TEXT, serving_size TEXT, serving_prefix TEXT)");
    }
    @Override
